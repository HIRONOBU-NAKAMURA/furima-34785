class DonationAddress
  ...
  def save
    ...
    # 住所を保存する
    Address.create(postal_code: postal_code, prefecture_id: prefecture, city: city, address_number: address_number,building_name: building_name,phone_number: phone_number,donation_id: donation.id)
  end
